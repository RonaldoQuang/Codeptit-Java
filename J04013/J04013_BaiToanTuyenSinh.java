...
class ts{
    ...
    public void kq(){
        ...
        if(x*10%10==0&&y*10%10==0) System.out.printf("%s %s %.0f %.0f %s",ma,ten,ut,tong,tt);
        else if(x*10%10==0&&y*10%10!=0) System.out.printf("%s %s %.0f %.1f %s",ma,ten,ut,tong,tt);
        else if(x*10%10!=0&&y*10%10==0) System.out.printf("%s %s %.1f %.0f %s",ma,ten,ut,tong,tt);
        else System.out.printf("%s %s %.1f %.1f %s",ma,ten,ut,tong,tt);
    }
}
