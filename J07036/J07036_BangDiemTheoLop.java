...
class BangDiem implements Comparable<BangDiem>{
    ...
    private double diem;
    public BangDiem(sv x, String ma, String mon, double diem){
        this.x=x;
        this.ma=ma;
        this.mon=mon;
        this.diem=diem;
    ...
    public void kq(){
        System.out.printf("%s %s %s %s ",x.getMa(),x.getTen(),ma,mon);
...
public class J07036_BangDiemTheoLop {
    public static void main(String[] args) throws Exception{
        ...
        while(m-->0){
            ...
            a.add(new BangDiem(mp.get(msv),ma,mp1.get(ma),diem));
        }
        Collections.sort(a);
        int q=sc2.nextInt();
        while(q-->0){
            String mau=sc2.next();
            System.out.println("BANG DIEM J05079.J05080.lop "+mau+":");
            for(BangDiem x:a){
